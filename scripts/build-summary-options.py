...
B=f'<section class="product-map"><div class="map-side map-left">{left}</div><figure class="map-product">'+pic('W04_strengths/body.png','PureNextホワイト本体')+f'<figcaption>PureNext</figcaption></figure><div class="map-side map-right">{right}</div></section><div class="service-band">'+''.join(card(k) for k in ['price','mall','repair','app'])+'</div>'
